...
| Phone |Input | User can only enter 15 digits |PASS|
...
| Edit a past booking | display | Cannot edit a booking that has already passed | PASS |
...
| Yes button| Click | Deletes booking and redirects to Bookings page (Reservation List) |PASS |
| No button | Click | Redirects to Bookings page (Reservation List) | PASS |
...
* When asked to enter the booking date, it was possible to enter past dates.
* When asked to enter the size of the party, it was possible to enter a negative number.
